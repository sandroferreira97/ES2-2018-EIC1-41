...
import graphs.HorizontalDimension;
import graphs.VerticalDimension;
...
public class Graph extends JPanel {
    ...
    public Graph(List<Double> scores, List<Double> knownSolutions) {
	this.scores = scores;
	...
	Graph graphPanel = new Graph(scores, knownSolutions);
	graphPanel.setPreferredSize(new Dimension(800, 600));
	VerticalDimension vertPanel = new VerticalDimension();
	HorizontalDimension horiPanel = new HorizontalDimension();
	...
	SwingUtilities.invokeLater(new Runnable() {
		...
		int count = 0;
		for(ArrayList<Double> list : fileReader.readFileAndReturnList(new File("C://Users//Duarte//Desktop//ISCTE/Engenharia de Software II/TesteValores.txt"))) {
